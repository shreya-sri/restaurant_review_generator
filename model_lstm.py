...
class LSTM(nn.Module):
    ...
    def __init__(self, vocab_size, embedding_dim, hidden_dim, n_layers, drop_prob=0.2):
        ...
        self.lstm = nn.LSTM(self.embedding_dim, self.hidden_dim, self.n_layers, dropout=drop_prob, batch_first=True, bidirectional=True)
    ...
    def init_hidden(self, batch_size):
        ...
        hidden = (torch.zeros(self.n_layers*2, batch_size, self.hidden_dim), torch.zeros(self.n_layers*2, batch_size, self.hidden_dim))
        return hidden